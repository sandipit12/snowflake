...
REM SQL SERVER
REM -----------
setx SOURCE_SERVER "10.36.130.131,1954" /M
setx SOURCE_DATABASE "venus_test" /M

REM DataLake
REM ----------

setx ADSL_STORAGE_ACCOUNT "tstweudatalakestor01" /M
...
setx SNOWFLAKE_CONN "test_environment" /M
